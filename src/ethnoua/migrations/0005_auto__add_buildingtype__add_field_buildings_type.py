...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('building_types', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('ethnoua', ['BuildingType'])

        # Adding field 'Buildings.type'
        db.add_column('bildings', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ethnoua.BuildingType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BuildingType'
        db.delete_table('building_types')

        # Deleting field 'Buildings.type'
        db.delete_column('bildings', 'type_id')
