...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LandingPageSubscription'
        db.create_table('landingpagesubscriptions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75)),
            ('bio', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('ethnoua', ['LandingPageSubscription'])
        ...
        db.send_create_signal('ethnoua', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'LandingPageSubscription'
        db.delete_table('landingpagesubscriptions')
    ...
    models = {
        ...
        'ethnoua.landingpagesubscription': {
            'Meta': {'object_name': 'LandingPageSubscription', 'db_table': "'landingpagesubscriptions'"},
